		...
		<>
			<div className={`md:flex md:gap-[30px] lg:gap-[60px] md:flex-row-reverse`}>
				...
				<div className="md:basis-1/2 only-md:mt-[40px] sm-max:mt-[35px]">
					<SectionTitle
						dataTitle="Sewer Installation"
						dataAddClass="blocktitle__topNone2"
					/>
					<p>
					The sewer is a system of pipes that carry sewage from all drains throughout the home. As an established plumbing outfit, we&apos;re equipped to handle all types of sewer installation projects.
					</p>
