          ...
          >
            {ReviewsCaruselData.map(
              ({
                ...
                <SwiperSlide key={id}>
                  <div
                    className={`${styles.testimonials__holder} main-bg relative md:flex md:justify-end md:items-stretch`}
                  >
                    <div
                    ...
                    ></div>
                    <div
                      className={`${styles.testimonials__content} md:relative z-[1]`}
                    >
                      <div
                      ...
                      >
                        ...
                        {signature__title && signature__text ? (
                          <div className={`${styles.reviews__caption} `}>
                            ...
                            <span className="text-sm">{signature__text}</span>
                          </div>
                        ) : null}
                      </div>
                    </div>
