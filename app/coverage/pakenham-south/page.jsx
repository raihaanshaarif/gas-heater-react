...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Pakenham South, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Pakenham South and surrounding suburbs.",
  keywords:
