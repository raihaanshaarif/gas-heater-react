...
export const metadata = {
  title:
    "Gas Heater Services Highett Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Highett, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Highett, gas heater installation Highett, gas heater repairs Melbourne, Highett gas heating, ducted gas heating Highett",
  alternates: {
