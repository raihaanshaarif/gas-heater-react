...
const boneoFaqs = [
  {
    question: "How much does a gas heater service cost in Boneo?",
    answer:
  ...
  {
    question: "Do you offer emergency gas heater repair in Boneo?",
    answer:
      "Absolutely. We offer urgent gas heater repair services throughout Boneo, from family homes to townhouse complexes and nearby local roads. If you notice gas odours or a total heating failure, call us immediately for priority response.",
  },
  {
...
,
  {
    question: "What types of gas heaters do you service in Boneo?",
    answer:
  ...
  {
    question: "Can you install a new gas heater in Boneo?",
    answer:
      "Yes, we provide full professional gas heater installation services in Boneo. Our licensed VBA technicians will design, install, and test your system to meet all Victorian safety standards. We provide competitive quotes and can typically schedule installation within 5-7 business days.",
  },
  {
    question: "What makes your Boneo gas heater service different?",
    answer:
      "We're a fully licensed, local Boneo gas heater company with fast response times, transparent pricing, and a commitment to customer safety. Every technician is VBA certified, and we stand behind our work with a satisfaction guarantee.",
  },
];
...
const serviceSchema = {
  ...
  provider: {
    ...
    areaServed: "Boneo VIC",
  },
  description:
    "Professional gas heater installation, repairs and servicing in Boneo, Melbourne with certified technicians and same-day response options.",
};

const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: boneoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
//Page Layout
export default function BoneoGasHeaterServices() {
  return (
    <>
      <PageTitle dataTitle="Gas Heater Services Boneo Melbourne" />
      <Script
        id="boneo-service-schema"
            ...
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                <div className="relative overflow-hidden rounded-[22px] border border-[#dbe5fb] bg-white/95 p-[24px] md:p-[30px] shadow-[0_22px_55px_rgba(14,47,116,0.12)] backdrop-blur-sm">
                  ...
                  <SectionTitle
                    dataSubtitle="boneo gas heater services"
                    dataTitle="Professional Gas Heater Services in Boneo, Melbourne"
                    dataMaxWidth="630px"
                  />
                  <div className="mt-[4px] grid gap-[10px] sm:grid-cols-3">
                    {[
                      ...
                      { label: "Local Coverage", value: "Boneo + Nearby" },
                    ].map((item) => (
                      <div
                        key={item.label}
                ...
                <h4 className="ttsubtitle ttsubtitle__top">
                  Gas Heater Services We Provide in Boneo:
                </h4>
                <ListWithTitle
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  What We Check During Your Boneo Gas Heater Service
                </h5>
                ...
                {/* Brands we service */}
                <h5 className="ttsubtitle ttsubtitle__top">
                  Gas Heater Brands We Service in Boneo
                </h5>
                ...
                <div className="grid gap-[12px] sm:grid-cols-2">
                  {[
                    ...
                    {
                      title: "Cold Spots",
                      body: "If certain rooms in your Boneo home are freezing while others are boiling, your ducted system may have ductwork damage or zone motor failures.",
                    },
                  ].map((sign) => (
                    <div
                      key={sign.title}
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Why Choose Our Gas Heater Services in Boneo?
                </h5>
                <p>
                  Boneo&apos;s mix of heritage homes and modern properties
                  requires specialized knowledge when it comes to gas heating
                  solutions. Our team understands the unique characteristics of
                  Boneo properties, from charming period homes to
                ...
                <p className="indent__top">
                  ...
                  familiar with Boneo&apos;s climate patterns and the
                ...
                <h5 className="ttsubtitle ttsubtitle__top">
                  Local Boneo Gas Heater Experts
                </h5>
                <p>
                  Living in Boneo means you appreciate quality, reliability,
                  ...
                  specialists in Boneo, Melbourne.
                </p>
                ...
                <div className="mt-[4px] grid gap-[16px] md:grid-cols-2">
                  <div className="rounded-[12px] border border-[#e6e8ef] bg-white p-[18px] shadow-[0_10px_24px_rgba(24,39,75,0.08)]">
                    <p className="mb-[10px] italic">
                      ...
                      of winter. The technician respected our older Boneo
                      property, kept everything clean, and had it fixed in about
                      an hour.&rdquo;
                    </p>
                    <p className="mb-0 font-semibold">&#8212; Sarah T., Family Home in Boneo</p>
                  </div>
                  <div className="rounded-[12px] border border-[#e6e8ef] bg-white p-[18px] shadow-[0_10px_24px_rgba(24,39,75,0.08)]">
                    <p className="mb-[10px] italic">
                  ...
                  <div className="rounded-[12px] border border-[#e6e8ef] bg-white p-[18px] shadow-[0_10px_24px_rgba(24,39,75,0.08)] md:col-span-2">
                    ...
                    <p className="mb-0 font-semibold">&#8212; Emma W., Boneo</p>
                  </div>
                </div>
                ...
                <div className="mt-[4px] grid gap-[12px] sm:grid-cols-2 lg:grid-cols-4">
                  <div className="rounded-[12px] border border-[#dce6fb] bg-[#f8fbff] p-[14px]">
                    ...
                    <p className="mb-0 text-[14px]">Call our local Boneo team or enquire online to secure an available appointment slot that suits your schedule.</p>
                  </div>
                  <div className="rounded-[12px] border border-[#dce6fb] bg-[#f8fbff] p-[14px]">
                ...
                {/* Nearby suburbs */}
                <h5 className="ttsubtitle ttsubtitle__top">
                  Also Serving Suburbs Near Boneo
                </h5>
                <div className="mt-[12px] flex flex-wrap gap-[8px]">
                  {[
                ...
                <PromoLayout
                  dataText="Get a free quote for gas heater installation, repair, or servicing in Boneo from our certified gas technicians today!"
              ...
              >
                ...
                <PromoAside
                  ...
                  dataText="Serving Boneo & Melbourne"
        ...
        <div className="mt-[40px] mb-[40px]">
          <div className="mb-[32px]">
            <SectionTitle
              ...
              dataTitle="Why Choose Us for Boneo Gas Heating"
              dataMaxWidth="480px"
            />
            <p className="mt-[16px] text-[15px] text-[#344a70]">
              Our team of licensed VBA technicians brings expertise, reliability, and local knowledge to every job in Boneo. We're committed to delivering the fastest response times and most transparent pricing in Melbourne.
            </p>
          </div>
            ...
            <div className="border border-[#e2e8f4] rounded-[12px] p-[24px] bg-gradient-to-br from-[#f8faff] to-white hover:shadow-lg transition-all duration-300">
              <div className="flex items-start gap-[16px]">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-[#344a70] leading-relaxed">We know Boneo neighborhoods and respond quickly to your heating needs. Our local presence ensures fast service and personal attention.</p>
                </div>
              </div>
            </div>
            <div className="border border-[#e2e8f4] rounded-[12px] p-[24px] bg-gradient-to-br from-[#f8faff] to-white hover:shadow-lg transition-all duration-300">
  ...
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "@id": "https://gasheaterservicemelbourne.com.au/coverage/boneo/#geo-business",
  "name": "Gas Heater Service Melbourne - Boneo",
  "description": "Professional gas heater repair, installation and maintenance services in Boneo, Melbourne. VBA licensed technicians, same-day emergency service.",
  "url": "https://gasheaterservicemelbourne.com.au/coverage/boneo/",
  "telephone": "0405 133 761",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Melbourne, Victoria",
    "addressLocality": "Boneo",
