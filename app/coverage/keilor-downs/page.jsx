...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Keilor Downs, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Keilor Downs and surrounding suburbs.",
  keywords:
