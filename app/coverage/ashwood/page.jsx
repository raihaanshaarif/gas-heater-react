...
,
  ...
  },
  {
    ...
    answer:
      "Yes, we provide full professional gas heater installation services in Ashwood. Our licensed  technicians will design, install, and test your system to meet all Victorian safety standards. We provide competitive quotes and can typically schedule installation within 5-7 business days.",
  },
  {
    question: "What makes your Ashwood gas heater service different?",
    answer:
      "We're a fully licensed, local Ashwood gas heater company with fast response times, transparent pricing, and a commitment to customer safety. Every technician is  certified, and we stand behind our work with a satisfaction guarantee.",
  },
];
...
export default function AshwoodGasHeaterServices() {
        ...
        <div className="mt-[40px] mb-[40px] max-w-6xl mx-auto px-[20px]">
          <div className="mb-[32px]">
            ...
            <p className="mt-[16px] text-[15px] text-[#344a70]">
              Our team of licensed  technicians brings expertise, reliability, and local knowledge to every job in Ashwood. We're committed to delivering the fastest response times and most transparent pricing in Melbourne.
            </p>
          </div>
  ...
  "description": "Professional gas heater repair, installation and maintenance services in Ashwood, Melbourne.  licensed technicians, same-day emergency service.",
