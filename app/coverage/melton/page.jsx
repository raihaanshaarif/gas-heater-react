...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Melton, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Melton and surrounding suburbs.",
  keywords:
            ...
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                ...
                <p className={``}>
                  ...
                  the unique heating needs of Melton homes and deliver
