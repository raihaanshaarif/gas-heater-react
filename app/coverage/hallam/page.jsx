...
export const metadata = {
  title:
    "Gas Heater Services Hallam Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Hallam, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Hallam, gas heater installation Hallam, gas heater repairs Melbourne, Hallam gas heating, ducted gas heating Hallam",
  alternates: {
