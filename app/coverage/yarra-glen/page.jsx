...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Yarra Glen, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Yarra Glen and surrounding suburbs.",
  keywords:
