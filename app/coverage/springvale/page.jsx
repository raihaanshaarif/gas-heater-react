...
export const metadata = {
  title:
    "Gas Heater Services Springvale Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Springvale, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Springvale, gas heater installation Springvale, gas heater repairs Melbourne, Springvale gas heating, ducted gas heating Springvale",
  alternates: {
