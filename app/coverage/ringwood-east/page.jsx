...
export const metadata = {
  title:
    "Gas Heater Services Ringwood East Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Ringwood East, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Ringwood East, gas heater installation Ringwood East, gas heater repairs Melbourne, Ringwood East gas heating, ducted gas heating Ringwood East",
  alternates: {
