...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Keilor, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Keilor and surrounding suburbs.",
  keywords:
