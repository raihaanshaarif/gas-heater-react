...
export const metadata = {
  title:
    "Gas Heater Services Hillside Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Hillside, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Hillside, gas heater installation Hillside, gas heater repairs Melbourne, Hillside gas heating, ducted gas heating Hillside",
  alternates: {
