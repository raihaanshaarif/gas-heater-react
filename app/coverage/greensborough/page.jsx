...
export const metadata = {
  title:
    "Gas Heater Services Greensborough Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Greensborough, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Greensborough, gas heater installation Greensborough, gas heater repairs Melbourne, Greensborough gas heating, ducted gas heating Greensborough",
  alternates: {
