...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Heatherton, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Heatherton and surrounding suburbs.",
  keywords:
