...
export const metadata = {
  title:
    "Gas Heater Services Sunshine Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Sunshine, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Sunshine, gas heater installation Sunshine, gas heater repairs Melbourne, Sunshine gas heating, ducted gas heating Sunshine",
  alternates: {
