...
const frankstonSouthFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, we provide full professional gas heater installation services in Frankston South. Our licensed VBA technicians will design, install, and test your system to meet all Victorian safety standards. We provide competitive quotes and can typically schedule installation within 5-7 business days.",
  },
  {
    question: "What makes your Frankston South gas heater service different?",
    answer:
      "We're a fully licensed, local Frankston South gas heater company with fast response times, transparent pricing, and a commitment to customer safety. Every technician is VBA certified, and we stand behind our work with a satisfaction guarantee.",
  }
];
...
export default function FrankstonSouthGasHeaterServices() {
          ...
          <div className="container container__fluid-xl">
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              ...
              >
                ...
                {/* Local Pricing Grid */}
                <div className="mt-[40px]">
                  <h3 className="ttitle text-[24px] md:text-[32px] mb-[24px]">Gas Heater Service Costs in Frankston South</h3>
  ...
  "description": "Professional gas heater repair, installation and maintenance services in Frankston South, Melbourne. VBA licensed technicians, same-day emergency service.",
