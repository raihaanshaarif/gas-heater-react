...
export const metadata = {
  title:
    "Gas Heater Services Southbank Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Southbank, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Southbank, gas heater installation Southbank, gas heater repairs Melbourne, Southbank gas heating, ducted gas heating Southbank",
  alternates: {
