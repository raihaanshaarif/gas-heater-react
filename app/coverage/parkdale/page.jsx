...
export const metadata = {
  title:
    "Gas Heater Services Parkdale Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Parkdale, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Parkdale, gas heater installation Parkdale, gas heater repairs Melbourne, Parkdale gas heating, ducted gas heating Parkdale",
  alternates: {
