...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Pascoe Vale, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Pascoe Vale and surrounding suburbs.",
  keywords:
                ...
                <div className="sm:flex sm:gap-[30px] mt-[20px]">
                  <div className="sm:basis-1/2">
                    <ul className="list__type1">
                      <li>
                        <a href="#">Pascoe Vale Homes & Units</a>
                      </li>
                      <li>
