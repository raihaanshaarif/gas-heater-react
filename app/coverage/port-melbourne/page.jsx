...
export const metadata = {
  title:
    "Gas Heater Services Port Melbourne Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Port Melbourne, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Port Melbourne, gas heater installation Port Melbourne, gas heater repairs Melbourne, Port Melbourne gas heating, ducted gas heating Port Melbourne",
  alternates: {
