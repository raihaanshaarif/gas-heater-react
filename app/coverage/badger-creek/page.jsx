...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Badger Creek, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Badger Creek and surrounding suburbs.",
  keywords:
                ...
                <div className="sm:flex sm:gap-[30px] mt-[20px]">
                  <div className="sm:basis-1/2">
                    <ul className="list__type1">
                      <li>
                        <a href="#">Badger Creek Homes & Units</a>
                      </li>
                      <li>
