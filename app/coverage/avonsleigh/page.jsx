...
export const metadata = {
  ...
  description:
    "Professional gas heater services in Avonsleigh, Melbourne. Expert installation, repairs, and maintenance for all gas heating systems. Certified technicians serving Avonsleigh and surrounding suburbs.",
  keywords:
            ...
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              <div className="lg:basis-2/3 md:basis-7/12 no-resize-text">
                ...
                <p className={``}>
                  ...
                  the unique heating needs of Avonsleigh homes and deliver
                ...
                <div className="sm:flex sm:gap-[30px] mt-[20px]">
                  <div className="sm:basis-1/2">
                    <ul className="list__type1">
                      <li>
                        <a href="#">Avonsleigh Homes & Units</a>
                      </li>
                      <li>
