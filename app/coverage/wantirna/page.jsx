...
export const metadata = {
  title:
    "Gas Heater Services Wantirna Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Wantirna, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Wantirna, gas heater installation Wantirna, gas heater repairs Melbourne, Wantirna gas heating, ducted gas heating Wantirna",
  alternates: {
