            ...
            <div className="md:flex md:gap-[30px] lg:gap-[60px]">
              ...
              >
                ...
                <div className="mt-[40px]">
                  <h3 className="ttitle text-[24px] md:text-[32px] mb-[24px]">Why Choose Us for Botanic Ridge Gas Heating</h3>
                  <div className="grid md:grid-cols-2 gap-[20px] text-[14px]">
                    <div className="border border-[#e2e8f4] rounded-[8px] p-[20px]">
                      ...
                      <p>We know Botanic Ridge neighborhoods and can respond quickly to your heating needs. Our local presence means fast service and personal attention.</p>
                    </div>
                    <div className="border border-[#e2e8f4] rounded-[8px] p-[20px]">
                ...
                {/* Local Pricing Grid */}
                <div className="mt-[40px]">
                  <h3 className="ttitle text-[24px] md:text-[32px] mb-[24px]">Gas Heater Service Costs in Botanic Ridge</h3>
