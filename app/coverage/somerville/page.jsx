...
export const metadata = {
  title:
    "Gas Heater Services Somerville Melbourne | Installation, Repairs & Servicing",
  description:
    "Professional gas heater services in Somerville, Melbourne. Expert installation, fast repairs, and annual maintenance. Carbon Monoxide testing included. Fully licensed VBA gas fitters.",
  keywords:
    "gas heater services Somerville, gas heater installation Somerville, gas heater repairs Melbourne, Somerville gas heating, ducted gas heating Somerville",
  alternates: {
