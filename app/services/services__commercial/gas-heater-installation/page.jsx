          ...
          <div className="container container__fluid">
            <div className={installStyles.hero__grid}>
              ...
              <div className={installStyles.hero__copy}>
                <div className="blocktitle__subtitle blocktitle__subtitle relative" style={{marginBottom:"12px"}}>commercial gas heater installation</div>
                <h1 className={installStyles.hero__h1}>
                  Professional Commercial Gas Heater Installation Melbourne
                </h1>
                <p className={installStyles.hero__sub}>
                  Fast, compliant installations by licensed gas fitters to keep your workplace warm through the bitter Melbourne winter.
                </p>
            ...
            <div className={installStyles.melbourne__grid}>
              ...
              <div className={installStyles.melbourne__copy}>
                ...
                <p className="indent__top">
                  A modern, correctly-sized gas heating system gives your team reliable, site-wide warmth the moment you need it — at a fraction of the running cost of older units. Whether you&apos;re replacing an ageing wall heater or upgrading to a full ducted system, our licensed gas fitters ensure the job is done right the first time, safely and to Australian Standards.
                </p>
            ...
            <div className={installStyles.ducted__grid}>
              <div className={installStyles.ducted__copy}>
                <SectionTitle
                  ...
                  dataTitle="Why Melbourne Businesses Choose Commercial Gas Heating"
                  dataMaxWidth="560px"
                />
                <p>
                  Ducted gas heating delivers consistent, site-wide warmth from a single powerful unit installed in your roof or plant space. Hot air is distributed via a network of ceiling or floor vents, meaning each zone reaches your target temperature quickly — without multiple appliances or cold spots.
                </p>
                ...
                <ul className={installStyles.benefit__list}>
                  ...
                  <li>
                    <span className={installStyles.benefit__icon}><IconCheck /></span>
                    <div>
                      <strong>Adds property value</strong>
              ...
              <div className={installStyles.ducted__img_wrap}>
                <Image
                  ...
                  style={{ objectFit: "cover" }}
                  quality={70}
                  alt="commercial gas heating Melbourne"
                  className={installStyles.rounded_img}
                />
        ...
        <section className={`section__inner base__bg ${installStyles.process_section}`}>
          <div className="container container__fluid">
            <SectionTitle
              ...
              dataTitle="How We Work: 4 Steps to a Warmer Workplace"
              dataMaxWidth="560px"
            />
              ...
              {[
                {
                  ...
                  text: "Our licensed gas fitter assesses your premises, occupancy zones, and load profile to determine the exact system size your site needs.",
                  img: "/images/step__img01.png",
                },
                {
                  num: "02",
                  title: "System Selection",
                  text: "We match the right brand and model to your premises, operating requirements, and budget — with transparent pricing before any work begins.",
          ...
          <div className="container container__fluid">
            <div className={installStyles.trust__grid}>
              <div className={installStyles.trust__left}>
                ...
                />
                <p>
                  Every installation we complete is backed by our commitment to safety, quality, and total transparency. We leave your premises exactly as we found them — except with a brand-new, fully compliant gas heating system.
                </p>
        ...
        <section className={`section__inner ${installStyles.testimonials_section}`}>
          <div className="container container__fluid">
            <SectionTitle
              ...
              dataTitle="Keeping Melbourne Businesses Warm"
              dataMaxWidth="560px"
