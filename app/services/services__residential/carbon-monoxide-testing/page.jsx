            ...
            <div className={coStyles.hero__grid}>
              ...
              <div>
                ...
                <p className={coStyles.hero__sub}>
                  Protect your family and stay legally compliant. Specialised CO spillage testing by licensed Melbourne gas fitters. Don&apos;t risk the &lsquo;silent killer&rsquo;.
                </p>
                <div className={coStyles.hero__ctas}>
                  <a href="tel:0405133761" className="btn btn__type2">
                    <span>Book a Safety Check</span>
                  </a>
                  <a href="#landlord" className={coStyles.hero__secondbtn}>
                    Landlord Compliance Info →
                  </a>
                </div>
