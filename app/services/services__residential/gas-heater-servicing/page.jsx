...
export default function GasHeaterServicing() {
  return (
    <>
      <PageTitle dataTitle="Gas Heater Servicing Melbourne" />
            ...
            <div className={servicingStyles.hero__grid}>
              ...
              <div>
                <div className="blocktitle__subtitle blocktitle__subtitle relative" style={{ marginBottom: "12px" }}>
                  gas heater servicing melbourne
                </div>
                <h1 className={servicingStyles.hero__h1}>
                  Comprehensive Gas Heater Service &amp; Maintenance Melbourne
                </h1>
                <p className={servicingStyles.hero__sub}>
                  Maximize efficiency, lower your energy bills, and keep your family safe with our comprehensive annual gas heater servicing — performed by fully VBA licensed gas fitters.
                </p>
          ...
          <div className="container container__fluid">
            <div className={servicingStyles.danger__grid}>
              ...
              <div className={servicingStyles.danger__copy}>
                ...
                />
                <p>
                  An unserviced gas heater works significantly harder to deliver the same warmth. Layers of dust on the heat exchanger act as insulation — forcing the burner to run longer and burn more gas to achieve your set temperature. Most Melbourne homeowners see their gas bills creep up every winter without ever suspecting their heater as the culprit.
                </p>
                <p>
              ...
              <div className={`${servicingStyles.bento__card} ${servicingStyles.bento__card_featured}`}>
                ...
                <div className={servicingStyles.bento__card_content}>
                  ...
                  <p className={servicingStyles.bento__text}>
                    Mandatory ESV-recommended CO testing on every visit. We measure ambient CO levels, check flue integrity, and certify your home safe — documented in a written report.
                  </p>
          ...
          <div className="container container__fluid">
            <div className={servicingStyles.trust__grid}>
              <div>
                ...
                />
                <p>
                  Every service visit runs on time, every technician is fully licensed, and every job ends with a clean home and a written service report. We don&apos;t use vague pricing — our flat-rate servicing fees are quoted upfront before any work begins.
                </p>
        ...
        <section className={`section__inner ${servicingStyles.testimonials_section}`}>
          <div className="container container__fluid">
            <SectionTitle
              ...
              dataTitle="Trusted by Thousands of Melbourne Homeowners"
              dataMaxWidth="580px"
          ...
          <div className={`container container__fluid ${servicingStyles.final_cta__inner}`}>
            <div>
              ...
              <p className={servicingStyles.final_cta__sub}>
                Don&apos;t wait until the cold snaps hit. Book your comprehensive gas heater service now and enjoy a warmer, safer, and more efficient home all winter long.
              </p>
              <a href="tel:0405133761" className="btn btn__type2">
