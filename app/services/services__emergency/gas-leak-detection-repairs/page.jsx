...
export default function GasLeakDetectionRepairs() {
  return (
    <>
      <PageTitle dataTitle="Emergency Gas Leak Detection & Repairs Melbourne | 24/7 Response" />
            ...
            <div className={emergencyStyles.hero__grid}>
              ...
              <div>
                ...
                <h1 className={emergencyStyles.hero__h1}>
                  Emergency Gas Leak Detection & Repair Melbourne
                </h1>
                <p className={emergencyStyles.hero__sub}>
                  Smell gas or suspect a leak? Our licensed emergency gas fitters respond 24/7 with leak detection equipment and immediate safety-first repairs.
                </p>
