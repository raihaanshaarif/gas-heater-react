...
// ── Hero Form ─────────────────────────────────────────────────────────────────
const propTypeOptions = ["Owner Occupier", "Landlord / Property Manager", "Real Estate Agent", "Pre-Purchase Inspection", "Commercial Property", "Other"];
...
const faqData = [
  ...
  {
    q: "Is a gas safety check mandatory for landlords in Victoria?",
    a: "Yes. Under the Residential Tenancies Act 1997 (as amended) and Energy Safe Victoria guidelines, Victorian landlords must have all gas appliances professionally serviced at least every 2 years and keep records of compliance. Failure to comply can result in significant penalties. Our reports are legally recognised documentation.",
  },
  {
...
export default function CarbonMonoxideAlarmResponse() {
  return (
    <>
      <PageTitle dataTitle="Carbon Monoxide Alarm Response Melbourne | 24/7 Emergency Service" />
      <main id="tt-pageContent" className="overflow-hidden bg-[radial-gradient(circle_at_top,#e7eefc_0%,#ffffff_42%)]">
            ...
            <div className={coStyles.hero__grid}>
              ...
              <div>
                <div className="blocktitle__subtitle blocktitle__subtitle relative" style={{ marginBottom: "12px" }}>
                  carbon monoxide alarm response melbourne
                </div>
                <h1 className={coStyles.hero__h1}>
                  Emergency Carbon Monoxide Alarm Response Melbourne
                </h1>
                <p className={coStyles.hero__sub}>
                  If your CO alarm is sounding, treat it as urgent. Our licensed gas fitters respond fast to inspect, isolate hazards, and make your property safe.
                </p>
                <div className={coStyles.hero__ctas}>
                  <a href="tel:0405133761" className="btn btn__type2">
                    <span>Call Emergency CO Team</span>
                  </a>
                  <a href="#silent-killer" className={coStyles.hero__secondbtn}>
                    Emergency CO Steps →
                  </a>
                </div>
        ...
        <section id="silent-killer" className={`section__inner ${coStyles.silent_section}`}>
          <div className="container container__fluid">
            <div className={coStyles.silent__grid}>
              ...
              <div>
                ...
                />
                <p>
                  Carbon monoxide is an odourless, colourless gas produced whenever gas, wood, or other fuels burn incompletely. A faulty gas heater — one with a cracked heat exchanger, blocked flue, or poorly calibrated burner — can flood your home with CO while you sleep, completely undetected.
                </p>
                <p className="indent__top">
                  Critically, <strong>standard smoke alarms do not detect carbon monoxide.</strong> Millions of Australian homeowners mistakenly believe they are protected because they have smoke detectors fitted. They are not. CO alarms exist separately — and even those only alert at dangerous threshold concentrations, missing the slow chronic low-level exposure that damages health over weeks.
                </p>
                ...
                <div className={coStyles.stat__row}>
                  ...
                  <div className={coStyles.stat__item}>
                    ...
                    <span>ESV mandatory testing interval for Victorian landlords</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className={`section__inner base__bg ${coStyles.bento_section}`}>
          <div className="container container__fluid">
            <SectionTitle
              ...
              dataTitle="Specialised CO Testing for Every Melbourne Property"
              dataMaxWidth="600px"
            />
            <div className={coStyles.bento__grid}>
              {/* Featured large card — landlords */}
              <div className={`${coStyles.bento__card} ${coStyles.bento__card_featured}`}>
                <div className={coStyles.bento__card_img}>
                  <Image
                    ...
                    style={{ objectFit: "cover" }}
                    quality={65}
                    alt="landlord gas safety compliance Melbourne"
                  />
                ...
                <div className={coStyles.bento__card_content}>
                  ...
                  <h3 className={coStyles.bento__title}>Landlords &amp; Property Managers</h3>
                  <p className={coStyles.bento__text}>
                    Victorian law requires gas safety checks every 2 years. We provide full legally recognised compliance documentation the same day — protecting your tenants and your investment.
                  </p>
                  <ul className={coStyles.bento__checklist}>
                    <li><IconCheckSm /> Residential Tenancies Act compliant report</li>
                    <li><IconCheckSm /> All appliances tested in a single visit</li>
                    <li><IconCheckSm /> Digital certificate emailed same day</li>
                  </ul>
                  <span className={coStyles.bento__tag}>2-Year Legal Requirement</span>
                </div>
              </div>
              ...
              <div className={`${coStyles.bento__card} ${coStyles.bento__card_standard}`}>
                ...
                <h3 className={coStyles.bento__title}>Homeowners</h3>
                <p className={coStyles.bento__text}>Especially if your heater is over 10 years old or your family experiences unexplained headaches during winter.</p>
              </div>
              ...
              <div className={`${coStyles.bento__card} ${coStyles.bento__card_standard}`}>
                ...
                <h3 className={coStyles.bento__title}>New Home Buyers</h3>
              ...
              <div className={`${coStyles.bento__card} ${coStyles.bento__card_standard}`}>
                ...
                <p className={coStyles.bento__text}>Structural changes and new exhaust fans alter your home&apos;s pressure balance — creating dangerous back-drafting risk that only testing can confirm.</p>
        ...
        {/* ── 4. LANDLORD COMPLIANCE SPOTLIGHT ────────────────────────── */}
        <section id="landlord" className={coStyles.landlord_section}>
          <div className="container container__fluid">
            <div className={coStyles.landlord__grid}>
              <div className={coStyles.landlord__copy}>
                <SectionTitle
                  dataSubtitle="victorian landlords"
                  dataTitle="Victorian Landlord Gas Safety Obligations"
                  dataMaxWidth="520px"
                />
                <p>
                  The Residential Tenancies Act 1997 (as amended) and Energy Safe Victoria guidelines place clear legal obligations on every Victorian landlord. Failure to comply isn&apos;t just dangerous — it exposes you to significant financial and legal penalties.
                </p>
                <ul className={coStyles.landlord__reqs}>
                  <li className={coStyles.landlord__req_item}>
                    ...
                    <div className={coStyles.landlord__req_text}>
                      <strong>Mandatory gas safety checks every 2 years</strong>
                      <span>All gas appliances on the property must be professionally tested and maintained at least every two years. Records must be kept and provided to tenants on request.</span>
                    </div>
                  </li>
                  <li className={coStyles.landlord__req_item}>
                    <div className={coStyles.landlord__req_icon}><IconDoc /></div>
                    <div className={coStyles.landlord__req_text}>
                      <strong>Detailed compliance reports required for renters</strong>
                      <span>Tenants have the right to a written record of the safety check. We provide fully documented, legally recognised digital reports the same day as the inspection.</span>
                    </div>
                  </li>
                  <li className={coStyles.landlord__req_item}>
                ...
                <div className={coStyles.landlord__badge}>
                  <span className={coStyles.landlord__badge_num}>2yr</span>
                  <span className={coStyles.landlord__badge_text}>Mandatory testing cycle<br />under Victorian law</span>
                </div>
              </div>
