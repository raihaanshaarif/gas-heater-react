            ...
            <div className={emergencyStyles.hero__grid}>
              ...
              <div>
                ...
                <h1 className={emergencyStyles.hero__h1}>
                  Emergency Gas Heater Shutdown Service Melbourne
                </h1>
                <p className={emergencyStyles.hero__sub}>
                  When a gas heater becomes unsafe, our team can isolate and shut it down immediately, then guide you through safe next steps and restoration options.
                </p>
                <div className={emergencyStyles.hero__ctas}>
                  ...
                  <a href="#dispatch" className={emergencyStyles.hero__callbtn}>
                    Request Immediate Safety Callback
                  </a>
                </div>
