...
export default function NoHeatingEmergencies() {
  return (
    <>
      <PageTitle dataTitle="No Heating Emergencies Melbourne | 24/7 Rapid Response" />
            ...
            <div className={repairStyles.hero__grid}>
              <div>
                <div className="blocktitle__subtitle blocktitle__subtitle relative" style={{ marginBottom: "12px" }}>
                  no heating emergency melbourne
                </div>
                <h1 className={repairStyles.hero__h1}>
                  No Heating Emergency Service Melbourne
                </h1>
                <p className={repairStyles.hero__sub}>
                  Heating failed completely? We provide fast emergency response across Melbourne to restore safe warmth as quickly as possible.
                </p>
                <div className={repairStyles.hero__ctas}>
                  <a href="tel:0405133761" className="btn btn__type2">
                    <span>Call for Emergency Heating</span>
                  </a>
            ...
            <div className={repairStyles.breakdown__grid}>
              ...
              <div>
                <SectionTitle
                  ...
                  dataTitle="Freezing House? Don't Wait for a Fix."
                />
                <p>
                  A broken heater in the middle of a Melbourne winter isn&apos;t just miserable — it&apos;s a genuine safety risk. Ignoring a heater that&apos;s making strange noises, producing unusual smells, or failing to ignite isn&apos;t just uncomfortable. It can mean a carbon monoxide leak is already underway inside your home.
                </p>
            ...
            <div className={repairStyles.co__grid}>
              ...
              <div className={repairStyles.co__copy}>
                <SectionTitle
                  ...
                  dataTitle="Don't Risk Your Family's Safety: Carbon Monoxide Testing"
                  dataMaxWidth="540px"
                />
                <p>
          ...
          <div className="container container__fluid">
            <div className={repairStyles.trust__grid}>
              <div>
                ...
                />
                <p>
                  Every repair is backed by upfront pricing, fully licensed tradespeople, and a commitment to leaving your home safe and warm. Our vans are stocked with genuine parts for all major brands so we can fix your heater in a single visit.
                </p>
        ...
        <section className={`section__inner ${repairStyles.testimonials_section}`}>
          <div className="container container__fluid">
            <SectionTitle
              ...
              dataTitle="Restoring Comfort to Melbourne Homes"
              dataMaxWidth="560px"
